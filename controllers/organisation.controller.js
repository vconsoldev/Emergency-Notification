...
import { registerOrganizationValidator } from "../validators/organization.validator.js";
// importing logger

export const organisationRegister = async (req, res) => {
  const db = await connectDB();
  let logger_target;
  try {
    const validatedData = registerOrganizationValidator.parse(req.body);
